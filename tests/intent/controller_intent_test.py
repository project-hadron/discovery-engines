...
class ControllerIntentTest(unittest.TestCase):
    ...
    def test_register_task(self):
        ...
        dc = self.instance
        synth_df = dc.activate_synthetic(task_name='hk_income', size=1000, uri_pm_repo=repo_uri, run_task=True)
        result = dc.activate_transition(canonical=synth_df, task_name='hk_income', uri_pm_repo=repo_uri, run_task=True, intent_order=2)
